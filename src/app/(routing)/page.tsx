...
import { getWeatherInfo, toFixedTemp } from "@/lib/weather-service/utils";
...
export default function Home() {
  ...
  // if (data?.error) return <p>Error: {data.message}</p>;
              ...
              {selectedHourlyForecast?.map((h) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mr-4 flex text-blue-600 ml-auto items-center gap-1">
                      <CloudRain className="" />
